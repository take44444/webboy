...
function __wbg_adapter_22(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9f8d421cd8441cd2(arg0, arg1);
}
...
export class AudioHandle {
    ...
    */
    static new() {
        const ret = wasm.audiohandle_new();
    ...
    */
    append(buffer) {
        ...
        wasm.audiohandle_append(this.__wbg_ptr, ptr0, len0);
    }
    /**
    * @returns {number}
    */
    length() {
        const ret = wasm.audiohandle_length(this.__wbg_ptr);
        return ret >>> 0;
    }
}
/**
...
export class GameBoyHandle {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(GameBoyHandle.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_gameboyhandle_free(ptr);
    }
    /**
    ...
    */
    static new(cart_rom, save, apu_callback, serial_callback) {
        const ptr0 = passArray8ToWasm0(cart_rom, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(save, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.gameboyhandle_new(ptr0, len0, ptr1, len1, addHeapObject(apu_callback), addHeapObject(serial_callback));
    ...
    */
    emulate_frame() {
        const ret = wasm.gameboyhandle_emulate_frame(this.__wbg_ptr);
    ...
    */
    key_down(k) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.gameboyhandle_key_down(this.__wbg_ptr, ptr0, len0);
    }
    /**
    * @param {string} k
    */
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('gbemu_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
